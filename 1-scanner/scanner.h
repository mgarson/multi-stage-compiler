...
//Author: Maija Garson
//Date: 03/14/2025
//Description: Header file that declares functions that will scan in and process tokens. Also defines structure that represents finite state automation table to assist with token transitions.
